...
export const toolsMetadata = {
  ...
  list_my_issues: {
    ...
    description:
      'List issues assigned to you (the current viewer) with filtering, keyword search, detail levels, and cursor pagination. This helper remains available to provider-level callers but is not part of the public MCP tool snapshot; use list_issues with assignedToMe=true over MCP.',
  },
